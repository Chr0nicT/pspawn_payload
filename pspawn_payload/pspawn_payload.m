...
//Try this because the above didn't work. Same app crashing error tho. Only happens when injecting ofc, cuz otherwise it's the default action.
...
static void ctor(void) {
    ...
    if (bootstrap_look_up(bootstrap_port, "ziyou.jailbreakd", &jbd_port)) {
